        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.ImageField(blank=True, null=True,
                    upload_to=apps.recruitment.models_profile.upload_foto,
                    verbose_name='Foto')),
                ('scan_ktp', models.FileField(blank=True, null=True,
                    upload_to=apps.recruitment.models_profile.upload_ktp,
                    verbose_name='Scan KTP')),
                ('scan_ijazah', models.FileField(blank=True, null=True,
                    upload_to=apps.recruitment.models_profile.upload_ijazah,
                    verbose_name='Scan Ijazah')),
                ('scan_skck', models.FileField(blank=True, null=True,
                    upload_to=apps.recruitment.models_profile.upload_skck,
                    verbose_name='Scan SKCK')),
                ('scan_npwp', models.FileField(blank=True, null=True,
                    upload_to=apps.recruitment.models_profile.upload_npwp,
